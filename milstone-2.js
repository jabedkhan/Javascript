...
// let project = "I want to build a multivendor website where user can buy and sell their products." ;
// let finalProject = project.slice(0, 20);
...
// let userInfo = `Name: ${firstName.concat(" " ,lastName)}
// Age: ${age}
// Result: ${result}`
...
// 18. Write a JavaScript program that can check if a string contains the given value. 
// 		Example:
...
// var myText = "The quick brown fox has jumped"
// var myInput = myText.includes("Fox")
